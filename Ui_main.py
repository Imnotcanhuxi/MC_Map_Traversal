...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_2.setPlaceholderText(
            QCoreApplication.translate("Form", "\u957f", None)
        )
        self.lineEdit_3.setPlaceholderText(
            QCoreApplication.translate("Form", "\u5bbd", None)
        )
        ...
        self.pushButton.setText(
            QCoreApplication.translate("Form", "\u751f\u6210!", None)
        )
        self.groupBox_3.setTitle(
            QCoreApplication.translate("Form", "\u8f93\u51fa", None)
        )
        self.groupBox_4.setTitle(
            QCoreApplication.translate("Form", "\u8f93\u5165", None)
        )
