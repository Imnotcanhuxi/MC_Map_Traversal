    ...
    def main(self):
        ...
        if self.inputEdit.text() == "":
            ...
            try:
                ...
                if map_id < 0:
                    self.plainTextEdit.appendPlainText("地图画编号不得为负!")
                    self.inputEdit.clear()
                    switch_about[1] == False
                else:
                    switch_about[1] = True
            except ValueError:
                self.plainTextEdit.appendPlainText("请输入正确的地图画编号!")
                self.inputEdit.clear()
                switch_about[1] == False
            ...
            if self.radioButton.isChecked():
                if self.lineEdit.text() == "":
                    ...
                    try:
                        ...
                        if num < 0:
                            self.plainTextEdit.appendPlainText("地图画数量不得为负!")
                            self.lineEdit.clear()
                            switch_about[0] = False
                        elif num > 729:
                        ...
                        self.plainTextEdit.appendPlainText("请输入正确的地图画数量!")
                        self.lineEdit.clear()
                        switch_about[0] = False
                ...
                if self.lineEdit_2.text() == "" and self.lineEdit_3.text() == "":
                    ...
                    try:
                        ...
                        if num < 0:
                            self.plainTextEdit.appendPlainText("地图画的面积不得为负!")
                        ...
                        self.plainTextEdit.appendPlainText("请输入正确的地图画的长宽!")
                        self.lineEdit_2.clear()
                        self.lineEdit_3.clear()
                        switch_about[0] == False
                ...
                if self.lineEdit_4.text() == "" and self.lineEdit_5.text() == "":
                    ...
                    try:
                        num = int(self.lineEdit_5.text()) - int(self.lineEdit_4.text())
                        if num < 0:
                            self.plainTextEdit.appendPlainText(
